...
jsPsych.plugins['image-slider-response'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    if (trial.show_value) {
        html += '<input type="range" class="jspsych-slider" value="' + trial.start + '" min="' + trial.min + '" max="' + trial.max + '" step="' + trial.step + '" style="width: 100%;" id="jspsych-image-slider-response-response" oninput="this.nextElementSibling.value = parseInt(this.value)"></input><output>' + trial.slider_start + '</output>';
      } else {
        html += '<input type="range" class="jspsych-slider" value="' + trial.start + '" min="' + trial.min + '" max="' + trial.max + '" step="' + trial.step + '" style="width: 100%;" id="jspsych-image-slider-response-response"></input><output></output>';
      }
    html += '<div>'
